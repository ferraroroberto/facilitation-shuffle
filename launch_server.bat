...
start "facilitation-shuffle-streamlit" /B ".venv\Scripts\python.exe" -m streamlit run "app\app.py" ^
    --server.port %PORT% ^
...
taskkill /fi "windowtitle eq facilitation-shuffle-streamlit" /f >nul 2>&1
echo.
echo Server stopped.
pause
